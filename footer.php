...
<footer class="footer">
  ...
  <div class="footer-block">
    <div class="row copyright">       <p class="footer-pr">&copy; <? echo date('Y');?> Истинный путь человека. Все права защищены.</p>    </div>
  	<div class="statistic">
...
<script type='text/javascript'>
(function(){ var widget_id = '3e8NgtWpaA';var d=document;var w=window;function l(){
